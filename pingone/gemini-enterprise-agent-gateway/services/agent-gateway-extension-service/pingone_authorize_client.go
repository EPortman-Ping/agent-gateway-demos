...
// based on user identity and HR directory tool access.
...
// Decide sends user and request attributes to PingOne Authorize and returns
// true for PERMIT, false for DENY or INDETERMINATE.
func (c *pingoneAuthorizeClient) Decide(userSub, toolName string, requestHour int) (bool, error) {
