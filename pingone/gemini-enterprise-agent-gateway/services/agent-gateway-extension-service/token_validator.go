...
// tokenValidator validates PingOne user tokens issued by the Gemini Enterprise
// auth manager's 3-legged OAuth flow. Checks signature (via JWKS), issuer,
// audience, and required scope.
...
func newTokenValidator(ctx context.Context, idpTokenEndpoint, audience, scope string) (*tokenValidator, error) {
