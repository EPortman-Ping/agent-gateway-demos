...
| `GC_GATEWAY_NAME` | The gateway from step 1, e.g. `baatt-agent-gateway` |
| `GC_EXT_SVC_NAME` | The deployed extension service's Cloud Run name |
...
![Agent Gateway Egress Destinations](../../../../_docs/baseline-autonomous-agent-to-tool/pingone/agent-gateway-egress-destinations.png)

## 4. Create the Agent Gateway Resource
